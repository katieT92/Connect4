        ...
        return NavigationView {        // Makes everything in this view navigatable and
            ...
            ZStack{             // Used to layer our background color and main elements
                ...
                VStack{         // Second stack in ZStack
                    ...
                    NavigationLink(destination: Stats()){   // Links the following Circle as a clickable item
                                                                        // to the destination View, "Opponent Selection"
                        Circle()
                            .fill(Color.red)
                            .frame(width: width * 0.5)
            ...
            .navigationBarTitle(Text("Menu"), displayMode: .automatic) //Counldt figure out how to align this to center, so commented out and added back in the "Connect 4" Text element as the first stack in our VStack above (Line26)
